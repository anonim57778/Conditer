...
export default function CartList({
    ...
    return (
        <div className="container h-screen flex flex-col gap-y-12 py-12 lg:py-16">
            <h2 className="text-5xl font-normal text-center lg:text-left">Ваша корзина</h2>

            {cp.length == 0 ? (
                <div className="grow flex flex-col gap-y-4 justify-center items-center">
                    <h1 className="text-primary text-center text-5xl">Ваша корзина пуста</h1>
